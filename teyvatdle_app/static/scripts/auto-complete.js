export function autocomplete(inp, arr) {
  ...
  inp.addEventListener("input", function (e) {
    ...
    a.setAttribute(
      "class",
      "autocomplete-items bg-[#f1e8e0] z-99 absolute w-[270px] left-1/2 -translate-x-1/2 max-h-[300px] overflow-y-scroll"
    );
    ...
    for (i = 0; i < arr.length; i++) {
      ...
      if (
        ...
        b.innerHTML =
          "<strong>" +
          characterName.substr(0, val.length).replace(" ", "&nbsp;") +
          "</strong>";
      ...
      if (
        characterNameParts.length > 1 &&
        characterNameParts[1].substr(0, val.length).toUpperCase() ==
          val.toUpperCase()
      ) {
        /*create a DIV element for each matching element:*/
        let container = document.createElement("DIV");
        ...
        b.innerHTML +=
          "<strong>&nbsp;" +
          characterNameParts[1].substr(0, val.length) +
          "</strong>";
